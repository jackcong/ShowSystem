...
t2v_util.t2vformat = {
    formatdatetime: function (dateTime, formater) {
        var date_paramater = dateTime;
        var year = date_paramater.getFullYear(); var month = date_paramater.getMonth()+1; var day = date_paramater.getDate();
