...
{
    [Serializable]
    abstract public class ParseException : System.Exception
    {
        public ParseException(string message, int errorIndex) : this(message, errorIndex, null) { }
        public ParseException(string message, int errorIndex, System.Exception inner)
    ...
    [Serializable]
    abstract public class CompileException : System.Exception
    {
        public CompileException(string message, int errorIndex) : this(message, errorIndex, null) { }
        public CompileException(string message, int errorIndex, System.Exception inner)
            : base(string.Format("位置{0}附近：{1}", errorIndex, message), inner) { }
    }
