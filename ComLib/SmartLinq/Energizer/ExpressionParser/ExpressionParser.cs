...
namespace ComLib.SmartLinq.Energizer.ExpressionParser
{
    ...
    static public class ExpressionParser
    {
        ...
        /// <param name="lambdaCode">lambda表达式代码。如：m=>m.ToString()</param>
        /// <param name="namespaces">命名空间集</param>
        static public TDelegate Compile<TDelegate, TResult>(string lambdaCode, params string[] namespaces)
        {
        ...
        /// <param name="lambdaCode">lambda表达式代码。如：m=>m.ToString()</param>
        /// <param name="namespaces">命名空间集</param>
        static public TDelegate Compile<TDelegate, TResult>(string lambdaCode, bool firstTypeIsDefaultInstance, params string[] namespaces)
        {
