namespace ComLib.SmartLinq.Energizer.ExpressionParser
{
    static public class ObjectDynamicExtension
    {
        ...
        static public T E<T>(this object instance, string code, string[] namespaces, params object[] objects)
            where T : class
        {
            return ComLib.SmartLinq.Energizer.ExpressionParser.ExpressionParser.Exec<T>(instance,code,namespaces,objects);
        }
        ...
        {
            return ComLib.SmartLinq.Energizer.ExpressionParser.ExpressionParser.Exec<T>(instance, code, null, objects);
        }
        ...
        {
            return ComLib.SmartLinq.Energizer.ExpressionParser.ExpressionParser.Exec(instance, code, namespaces, objects);
        }
        ...
        {
            return ComLib.SmartLinq.Energizer.ExpressionParser.ExpressionParser.Exec(instance, code, null, objects);
        }
    }
}
